...
package org.silex.adminApi.listModels
{
	...
	/**
	 * the silex list model for messages
	 * */
	public class Messages extends ListModelBase
	{
		
		public static const STATUS_INFO:String = "info";
	
		public static const STATUS_DEBUG:String = "debug";
		...
		{
			super();
			_equivalentAS2ObjectName = "messages";
			_dataType = Message;
