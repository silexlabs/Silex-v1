...
/**
 * The state used when at least one component is selected but the user is not currently
 * interacting with the user interface. Takes all it's behaviour from StateBase
 * @author Yannick DOMINGUEZ
 */
class SelectedState extends StateBase
{
	/////////////////////**/*/*/*/*/*/*/
	// CONSTRUCTOR
	////////////////////**/*/*/*/*/*/*/
