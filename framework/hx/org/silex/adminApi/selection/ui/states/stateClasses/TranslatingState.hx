...
/**
 * The state used when the user moves the currently selected components with the mouse. Dispatches signals for the 
 * SelectionManager containing the translation data
 * @author Yannick DOMINGUEZ
 */
class TranslatingState extends TransformationStateBase
{
	/////////////////////**/*/*/*/*/*/*/
	// CONSTRUCTOR
	////////////////////**/*/*/*/*/*/*/
	...
	{
		return SelectionManagerEvent.SELECTION_START_TRANSLATION;
	}
	...
	{
		return SelectionManagerEvent.SELECTION_TRANSLATING;
	}
	...
	{
		return SelectionManagerEvent.SELECTION_STOP_TRANSLATING;
	}
