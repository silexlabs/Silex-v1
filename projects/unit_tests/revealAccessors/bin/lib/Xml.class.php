...
function Xml_0(&$it, &$me) {
	$»spos = $GLOBALS['%s']->length;
	{
		$GLOBALS['%s']->push("Xml::iterator@244");
...
function Xml_1(&$it, &$me) {
	$»spos = $GLOBALS['%s']->length;
	{
		$GLOBALS['%s']->push("Xml::iterator@247");
		$»spos2 = $GLOBALS['%s']->length;
		{
			$»tmp = $it->x[$it->cur++];
			$GLOBALS['%s']->pop();
...
function Xml_2(&$it, &$me) {
	$»spos = $GLOBALS['%s']->length;
	{
		$GLOBALS['%s']->push("Xml::elements@261");
		$»spos2 = $GLOBALS['%s']->length;
		$k = $it->cur;
		$l = _hx_len($it->x);
		while($k < $l) {
...
function Xml_3(&$it, &$me) {
	$»spos = $GLOBALS['%s']->length;
	{
		$GLOBALS['%s']->push("Xml::elements@273");
		$»spos2 = $GLOBALS['%s']->length;
		$k = $it->cur;
		$l = _hx_len($it->x);
		while($k < $l) {
...
function Xml_4(&$it, &$me, &$name) {
	$»spos = $GLOBALS['%s']->length;
	{
		$GLOBALS['%s']->push("Xml::elementsNamed@298");
		$»spos2 = $GLOBALS['%s']->length;
		$k = $it->cur;
		$l = _hx_len($it->x);
		while($k < $l) {
...
function Xml_5(&$it, &$me, &$name) {
	$»spos = $GLOBALS['%s']->length;
	{
		$GLOBALS['%s']->push("Xml::elementsNamed@310");
		$»spos2 = $GLOBALS['%s']->length;
		$k = $it->cur;
		$l = _hx_len($it->x);
		while($k < $l) {
