...
class org_silex_core_seo_LayerSeo {
	...
	static function read($fileName, $deeplink) {
		$GLOBALS['%s']->push("org.silex.core.seo.LayerSeo::read");
	...
	static function readLayerSeoModel($fileName, $deeplink) {
		$GLOBALS['%s']->push("org.silex.core.seo.LayerSeo::readLayerSeoModel");
		$»spos = $GLOBALS['%s']->length;
		if($deeplink === null) {
			$deeplink = "";
		}
	...
	static function readXml($fileName, $deeplink) {
		$GLOBALS['%s']->push("org.silex.core.seo.LayerSeo::readXml");
		$»spos = $GLOBALS['%s']->length;
		if($deeplink === null) {
			$deeplink = "";
		}
	...
	static function xml2LayerSeoModel($xml) {
		$GLOBALS['%s']->push("org.silex.core.seo.LayerSeo::xml2LayerSeoModel");
		$»spos = $GLOBALS['%s']->length;
	...
	static function layerSeoModel2PhpArray($layerSeoModel) {
		$GLOBALS['%s']->push("org.silex.core.seo.LayerSeo::layerSeoModel2PhpArray");
		$»spos = $GLOBALS['%s']->length;
	...
	static function write($fileName, $deeplink, $layerSeoModelArray, $indent) {
		$GLOBALS['%s']->push("org.silex.core.seo.LayerSeo::write");
		$»spos = $GLOBALS['%s']->length;
	...
	static function writeLayerSeoModel($fileName, $deeplink, $layerSeoModel, $indent) {
		$GLOBALS['%s']->push("org.silex.core.seo.LayerSeo::writeLayerSeoModel");
		$»spos = $GLOBALS['%s']->length;
		$layerSeoModelXml = org_silex_core_seo_LayerSeo::layerSeoModel2Xml($layerSeoModel, $deeplink);
		org_silex_core_seo_LayerSeo::writeXml($fileName, $deeplink, $layerSeoModelXml, $indent);
		$GLOBALS['%s']->pop();
	...
	static function phpArray2LayerSeoModel($layerSeoArray, $deeplink) {
		$GLOBALS['%s']->push("org.silex.core.seo.LayerSeo::phpArray2LayerSeoModel");
		$»spos = $GLOBALS['%s']->length;
		$layerSeoModel = null;
	...
	static function layerSeoModel2Xml($layerSeoModel, $deeplink) {
		$GLOBALS['%s']->push("org.silex.core.seo.LayerSeo::layerSeoModel2Xml");
		$»spos = $GLOBALS['%s']->length;
	...
	static function writeXml($fileName, $deeplink, $xmlContent, $indent) {
		$GLOBALS['%s']->push("org.silex.core.seo.LayerSeo::writeXml");
		$»spos = $GLOBALS['%s']->length;
		...
		if(file_exists($fileName)) {
			...
			if($layerSeoXmlOriginal !== null) {
				...
				if($layerSeoXmlOriginal->getNodeName() === org_silex_core_seo_LayerSeo::$SEO_DATA_NODE_NAME && $layerSeoXmlOriginal->get(org_silex_core_seo_LayerSeo::$VERSION_ATTRIBUTE_NAME) === org_silex_core_seo_LayerSeo::$VERSION_ATTRIBUTE_VALUE) {
					...
					haxe_Log::trace("Publication layer seo file is not in the v2 format for deeplink: " . $deeplink . ". Please save it manually via the Wysiwyg", _hx_anonymous(array("fileName" => "LayerSeo.hx", "lineNumber" => 610, "className" => "org.silex.core.seo.LayerSeo", "methodName" => "writeXml")));
				}
			}
		} else {
			haxe_Log::trace("Seo file does not exists", _hx_anonymous(array("fileName" => "LayerSeo.hx", "lineNumber" => 616, "className" => "org.silex.core.seo.LayerSeo", "methodName" => "writeXml")));
		}
