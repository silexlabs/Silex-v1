...
class LabelButtonPlus03 extends org.silex.ui.components.buttons.ButtonBase {
	...
	function _initialize() {
		...
		this.editableProperties.unshift(
			...
			{ name :"buttonLabelNormal" ,		description:"PROPERTIES_LABEL_ATTRIBUTES", 				type: "Text"		, defaultValue: '<FONT FACE="Arial" SIZE="12" COLOR="#3B3024">label</FONT>'	, isRegistered:true,group:"attributes" },
			{ name :"buttonLabelSelect" ,		description:"PROPERTIES_LABEL_LABEL_SELECT", 				type: "Text"		, defaultValue: '<FONT FACE="Arial" SIZE="12" COLOR="#3B3024">label</FONT>'	, isRegistered:true,group:"attributes" },
			{ name :"buttonLabelOver" ,		description:"PROPERTIES_LABEL_LABEL_OVER", 				type: "Text"		, defaultValue: '<FONT FACE="Arial" SIZE="12" COLOR="#3B3024">label</FONT>'	, isRegistered:true,group:"attributes" },
			{ name :"buttonLabelPress" ,		description:"PROPERTIES_LABEL_LABEL_PRESS", 				type: "Text"		, defaultValue: '<FONT FACE="Arial" SIZE="12" COLOR="#3B3024">label</FONT>'	, isRegistered:true,group:"attributes" }
		);
	}
	/**
