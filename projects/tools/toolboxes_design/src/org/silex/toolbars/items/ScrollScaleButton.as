package org.silex.toolbars.items
{
	...
	public class ScrollScaleButton extends Sprite {

		public var button:SimpleButton;
		
		public function ScrollScaleButton() 
		{
			if (SilexAdminApi.getInstance().publicationModel.getScaleMode() == PublicationModel.SCROLL)
			{
		...
		{
				SilexAdminApi.getInstance().publicationModel.setScaleMode(PublicationModel.SCROLL);
