package org.silex.toolbars.items
{
	...
	public class OpenWysiwyg extends Sprite {

		public var button:SimpleButton;
		
		public function OpenWysiwyg() 
		{
		...
		{
			removeChild(button);
			if (SilexAdminApi.getInstance().wysiwygModel.getToolBoxDisplayMode() == WysiwygModel.TOOLBOX_DISPLAY_MODE_DIV
