...
{
	public class CreateItemAlertVO extends AlertToolVO
	{
		...
		public function CreateItemAlertVO(title:String, alertMsg:String, alertYesLabel:String, alertNoLabel:String)
		{
