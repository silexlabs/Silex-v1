...
{
	/**
	 * An interface implemented by classes who needs to wrap the action classes.
	 */
	public interface IAction
	{
		/**
		 * returns the name of the function assocated with this action
		 */ 
		function get functionName():String;
		
		/**
		 * returns the modifier of the action
		 */ 
