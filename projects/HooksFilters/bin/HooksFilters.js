...
tests.FiltersOrder = function(p) { if( p === $_ ) return; {
	$s.push("tests.FiltersOrder::new");
	var $spos = $s.length;
	null;
	$s.pop();
}}
tests.FiltersOrder.__name__ = ["tests","FiltersOrder"];
tests.FiltersOrder.prototype.testOrderInvert = function() {
	$s.push("tests.FiltersOrder::testOrderInvert");
	var $spos = $s.length;
	var firstChain = new org.silex.filters.FilterChain();
	firstChain.addFilter($closure(this,"addOne"),1);
	firstChain.addFilter($closure(this,"double"),0);
	var result = firstChain.applyFilters(12,{ });
	utest.Assert.equals(25,result,null,{ fileName : "FiltersOrder.hx", lineNumber : 19, className : "tests.FiltersOrder", methodName : "testOrderInvert"});
	$s.pop();
}
tests.FiltersOrder.prototype.testOrder = function() {
	$s.push("tests.FiltersOrder::testOrder");
	var $spos = $s.length;
	var firstChain = new org.silex.filters.FilterChain();
	firstChain.addFilter($closure(this,"addOne"),0);
	firstChain.addFilter($closure(this,"double"),1);
	var result = firstChain.applyFilters(12,{ });
	utest.Assert.equals(26,result,null,{ fileName : "FiltersOrder.hx", lineNumber : 28, className : "tests.FiltersOrder", methodName : "testOrder"});
	$s.pop();
}
tests.FiltersOrder.prototype.addOne = function(value,context) {
	$s.push("tests.FiltersOrder::addOne");
	var $spos = $s.length;
	{
		var $tmp = value + 1;
		$s.pop();
...
tests.FiltersOrder.prototype["double"] = function(value,context) {
	$s.push("tests.FiltersOrder::double");
	var $spos = $s.length;
	{
		var $tmp = value * 2;
		$s.pop();
...
tests.FiltersOrder.prototype.__class__ = tests.FiltersOrder;
...
utest.ui.text.HtmlReport.prototype._handler = function(report) {
	...
	var isDef = function(v) {
		$s.push("utest.ui.text.HtmlReport::_handler@652");
		var $spos = $s.length;
		{
...
tests.FiltersAddingDeleting = function(p) { if( p === $_ ) return; {
	$s.push("tests.FiltersAddingDeleting::new");
	var $spos = $s.length;
	null;
	$s.pop();
}}
tests.FiltersAddingDeleting.__name__ = ["tests","FiltersAddingDeleting"];
tests.FiltersAddingDeleting.fieldFunction = function(value,context) {
	$s.push("tests.FiltersAddingDeleting::fieldFunction");
	var $spos = $s.length;
	{
		$s.pop();
		return value;
...
tests.FiltersAddingDeleting.prototype.testAddingClosure = function() {
	$s.push("tests.FiltersAddingDeleting::testAddingClosure");
	var $spos = $s.length;
	var firstChain = new org.silex.filters.FilterChain();
	firstChain.addFilter($closure(this,"addOne"),2);
	utest.Assert.equals(1,firstChain.filters.length,null,{ fileName : "FiltersAddingDeleting.hx", lineNumber : 18, className : "tests.FiltersAddingDeleting", methodName : "testAddingClosure"});
	$s.pop();
}
tests.FiltersAddingDeleting.prototype.testAddingFieldFunction = function() {
	$s.push("tests.FiltersAddingDeleting::testAddingFieldFunction");
	var $spos = $s.length;
	var firstChain = new org.silex.filters.FilterChain();
	firstChain.addFilter(tests.FiltersAddingDeleting.fieldFunction,0);
	var result = firstChain.applyFilters(6,{ });
	utest.Assert.equals(1,firstChain.filters.length,null,{ fileName : "FiltersAddingDeleting.hx", lineNumber : 26, className : "tests.FiltersAddingDeleting", methodName : "testAddingFieldFunction"});
	$s.pop();
}
tests.FiltersAddingDeleting.prototype.testRemovingClosure = function() {
	$s.push("tests.FiltersAddingDeleting::testRemovingClosure");
	var $spos = $s.length;
	var firstChain = new org.silex.filters.FilterChain();
	firstChain.addFilter($closure(this,"addOne"),2);
	firstChain.removeFilter($closure(this,"addOne"));
	utest.Assert.equals(0,firstChain.filters.length,null,{ fileName : "FiltersAddingDeleting.hx", lineNumber : 34, className : "tests.FiltersAddingDeleting", methodName : "testRemovingClosure"});
	$s.pop();
}
tests.FiltersAddingDeleting.prototype.testRemovingFieldFunction = function() {
	$s.push("tests.FiltersAddingDeleting::testRemovingFieldFunction");
	var $spos = $s.length;
	var firstChain = new org.silex.filters.FilterChain();
	firstChain.addFilter(tests.FiltersAddingDeleting.fieldFunction,2);
	firstChain.removeFilter(tests.FiltersAddingDeleting.fieldFunction);
	utest.Assert.equals(0,firstChain.filters.length,null,{ fileName : "FiltersAddingDeleting.hx", lineNumber : 42, className : "tests.FiltersAddingDeleting", methodName : "testRemovingFieldFunction"});
	$s.pop();
}
tests.FiltersAddingDeleting.prototype.addOne = function(value,context) {
	$s.push("tests.FiltersAddingDeleting::addOne");
	var $spos = $s.length;
	{
		var $tmp = value + 1;
		$s.pop();
...
tests.FiltersAddingDeleting.prototype.addTwo = function(value,context) {
	$s.push("tests.FiltersAddingDeleting::addTwo");
	var $spos = $s.length;
	{
		var $tmp = value + 2;
		$s.pop();
...
tests.FiltersAddingDeleting.prototype.__class__ = tests.FiltersAddingDeleting;
...
tests.HooksApplication = function(p) { if( p === $_ ) return; {
	$s.push("tests.HooksApplication::new");
	var $spos = $s.length;
	null;
	$s.pop();
}}
tests.HooksApplication.__name__ = ["tests","HooksApplication"];
tests.HooksApplication.prototype.testApplicationOneHook = function() {
	$s.push("tests.HooksApplication::testApplicationOneHook");
	var $spos = $s.length;
	var firstChain = new org.silex.hooks.HookChain();
	firstChain.addHook($closure(this,"hookTest"),0);
	utest.Assert.raises(function() {
		$s.push("tests.HooksApplication::testApplicationOneHook@17");
		var $spos = $s.length;
		firstChain.callHooks("An exception");
		$s.pop();
	},String,null,null,{ fileName : "HooksApplication.hx", lineNumber : 17, className : "tests.HooksApplication", methodName : "testApplicationOneHook"});
	$s.pop();
}
tests.HooksApplication.prototype.testApplicationTwoHooks = function() {
	$s.push("tests.HooksApplication::testApplicationTwoHooks");
	var $spos = $s.length;
	var firstChain = new org.silex.hooks.HookChain();
	firstChain.addHook($closure(this,"hookTest"),0);
	firstChain.addHook($closure(this,"hookTest"),0);
	utest.Assert.raises(function() {
		$s.push("tests.HooksApplication::testApplicationTwoHooks@27");
		var $spos = $s.length;
		firstChain.callHooks(12);
		$s.pop();
	},Int,null,null,{ fileName : "HooksApplication.hx", lineNumber : 27, className : "tests.HooksApplication", methodName : "testApplicationTwoHooks"});
	$s.pop();
}
tests.HooksApplication.prototype.testAddingTwoHooks = function() {
	$s.push("tests.HooksApplication::testAddingTwoHooks");
	var $spos = $s.length;
	var firstChain = new org.silex.hooks.HookChain();
	var _hookTest = $closure(this,"hookTest");
	var _hookTest2 = $closure(this,"hookTest2");
	firstChain.addHook(_hookTest,0);
	firstChain.addHook(_hookTest2,0);
	utest.Assert.equals(2,firstChain.hooks.length,null,{ fileName : "HooksApplication.hx", lineNumber : 39, className : "tests.HooksApplication", methodName : "testAddingTwoHooks"});
	$s.pop();
}
tests.HooksApplication.prototype.hookTest = function(value) {
	$s.push("tests.HooksApplication::hookTest");
	var $spos = $s.length;
	throw value;
	$s.pop();
}
tests.HooksApplication.prototype.hookTest2 = function(value) {
	$s.push("tests.HooksApplication::hookTest2");
	var $spos = $s.length;
	throw value;
	$s.pop();
}
tests.HooksApplication.prototype.__class__ = tests.HooksApplication;
...
tests.HookManagerApplication = function(p) { if( p === $_ ) return; {
	$s.push("tests.HookManagerApplication::new");
	var $spos = $s.length;
	null;
	$s.pop();
}}
tests.HookManagerApplication.__name__ = ["tests","HookManagerApplication"];
tests.HookManagerApplication.prototype.testApplicationOneHook = function() {
	$s.push("tests.HookManagerApplication::testApplicationOneHook");
	var $spos = $s.length;
	org.silex.hooks.HookManager.addHook("firstChain",$closure(this,"hookTest"),0);
	utest.Assert.raises(function() {
		$s.push("tests.HookManagerApplication::testApplicationOneHook@18");
		var $spos = $s.length;
		org.silex.hooks.HookManager.callHooks("firstChain","An exception");
		$s.pop();
	},String,null,null,{ fileName : "HookManagerApplication.hx", lineNumber : 18, className : "tests.HookManagerApplication", methodName : "testApplicationOneHook"});
	$s.pop();
}
tests.HookManagerApplication.prototype.testApplicationTwoHooks = function() {
	$s.push("tests.HookManagerApplication::testApplicationTwoHooks");
	var $spos = $s.length;
	org.silex.hooks.HookManager.addHook("secondChain",$closure(this,"hookTest"),0);
	org.silex.hooks.HookManager.addHook("secondChain",$closure(this,"hookTest"),0);
	utest.Assert.raises(function() {
		$s.push("tests.HookManagerApplication::testApplicationTwoHooks@27");
		var $spos = $s.length;
		org.silex.hooks.HookManager.callHooks("secondChain",12);
		$s.pop();
	},Int,null,null,{ fileName : "HookManagerApplication.hx", lineNumber : 27, className : "tests.HookManagerApplication", methodName : "testApplicationTwoHooks"});
	$s.pop();
}
tests.HookManagerApplication.prototype.testAddingTwoHooks = function() {
	$s.push("tests.HookManagerApplication::testAddingTwoHooks");
	var $spos = $s.length;
	var _hookTest = $closure(this,"hookTest");
	var _hookTest2 = $closure(this,"hookTest2");
	org.silex.hooks.HookManager.addHook("testAddingTwoHooksChain",_hookTest,0);
	org.silex.hooks.HookManager.addHook("testAddingTwoHooksChain",_hookTest2,0);
	utest.Assert.equals(2,org.silex.hooks.HookManager.hookChains.get("testAddingTwoHooksChain").hooks.length,null,{ fileName : "HookManagerApplication.hx", lineNumber : 38, className : "tests.HookManagerApplication", methodName : "testAddingTwoHooks"});
	$s.pop();
}
tests.HookManagerApplication.prototype.testRemovingHook = function() {
	$s.push("tests.HookManagerApplication::testRemovingHook");
	var $spos = $s.length;
	var _hookTest = $closure(this,"hookTest");
	var _hookTest2 = $closure(this,"hookTest2");
	org.silex.hooks.HookManager.addHook("testRemovingHookChain",_hookTest,0);
	org.silex.hooks.HookManager.addHook("testRemovingHookChain",_hookTest2,0);
	org.silex.hooks.HookManager.removeHook("testRemovingHookChain",_hookTest);
	utest.Assert.equals(1,org.silex.hooks.HookManager.hookChains.get("testRemovingHookChain").hooks.length,null,{ fileName : "HookManagerApplication.hx", lineNumber : 48, className : "tests.HookManagerApplication", methodName : "testRemovingHook"});
	$s.pop();
}
tests.HookManagerApplication.prototype.testRemovingHookViaClosure = function() {
	$s.push("tests.HookManagerApplication::testRemovingHookViaClosure");
	var $spos = $s.length;
	var _hookTest = $closure(this,"hookTest");
	var _hookTest2 = $closure(this,"hookTest2");
	org.silex.hooks.HookManager.addHook("testRemovingHookViaClosureChain",_hookTest,0);
	org.silex.hooks.HookManager.addHook("testRemovingHookViaClosureChain",_hookTest2,0);
	org.silex.hooks.HookManager.removeHook("testRemovingHookViaClosureChain",$closure(this,"hookTest"));
	utest.Assert.equals(1,org.silex.hooks.HookManager.hookChains.get("testRemovingHookViaClosureChain").hooks.length,null,{ fileName : "HookManagerApplication.hx", lineNumber : 59, className : "tests.HookManagerApplication", methodName : "testRemovingHookViaClosure"});
	$s.pop();
}
tests.HookManagerApplication.prototype.hookTest = function(value) {
	$s.push("tests.HookManagerApplication::hookTest");
	var $spos = $s.length;
	throw value;
	$s.pop();
}
tests.HookManagerApplication.prototype.hookTest2 = function(value) {
	$s.push("tests.HookManagerApplication::hookTest2");
	var $spos = $s.length;
	throw value;
	$s.pop();
}
tests.HookManagerApplication.prototype.__class__ = tests.HookManagerApplication;
...
HooksFilters = function(p) { if( p === $_ ) return; {
	$s.push("HooksFilters::new");
	var $spos = $s.length;
	null;
	$s.pop();
}}
HooksFilters.__name__ = ["HooksFilters"];
HooksFilters.main = function() {
	$s.push("HooksFilters::main");
	var $spos = $s.length;
	var m = new HooksFilters();
	var runner = new utest.Runner();
	runner.addCase(new tests.FiltersOrder());
	runner.addCase(new tests.FiltersApplication());
	runner.addCase(new tests.FiltersAddingDeleting());
	runner.addCase(new tests.HooksApplication());
	runner.addCase(new tests.HookManagerApplication());
	var report = utest.ui.Report.create(runner);
	runner.run();
	$s.pop();
}
HooksFilters.plusOne = function(value,context) {
	$s.push("HooksFilters::plusOne");
	var $spos = $s.length;
	{
		var $tmp = value + 1;
		$s.pop();
...
HooksFilters["double"] = function(value,context) {
	$s.push("HooksFilters::double");
	var $spos = $s.length;
	{
		var $tmp = value * 2;
		$s.pop();
...
HooksFilters.prototype.__class__ = HooksFilters;
tests.FiltersApplication = function(p) { if( p === $_ ) return; {
	$s.push("tests.FiltersApplication::new");
	var $spos = $s.length;
	null;
	$s.pop();
}}
tests.FiltersApplication.__name__ = ["tests","FiltersApplication"];
tests.FiltersApplication.prototype.testApplicationOneFilter = function() {
	$s.push("tests.FiltersApplication::testApplicationOneFilter");
	var $spos = $s.length;
	var firstChain = new org.silex.filters.FilterChain();
	firstChain.addFilter($closure(this,"addOne"),1);
	var result = firstChain.applyFilters(3,{ });
	utest.Assert.equals(4,result,null,{ fileName : "FiltersApplication.hx", lineNumber : 18, className : "tests.FiltersApplication", methodName : "testApplicationOneFilter"});
	$s.pop();
}
tests.FiltersApplication.prototype.testApplicationTwoFilters = function() {
	$s.push("tests.FiltersApplication::testApplicationTwoFilters");
	var $spos = $s.length;
	var firstChain = new org.silex.filters.FilterChain();
	firstChain.addFilter($closure(this,"addOne"),0);
	firstChain.addFilter($closure(this,"addTwo"),1);
	var result = firstChain.applyFilters(6,{ });
	utest.Assert.equals(9,result,null,{ fileName : "FiltersApplication.hx", lineNumber : 27, className : "tests.FiltersApplication", methodName : "testApplicationTwoFilters"});
	$s.pop();
}
tests.FiltersApplication.prototype.addOne = function(value,context) {
	$s.push("tests.FiltersApplication::addOne");
	var $spos = $s.length;
	{
		var $tmp = value + 1;
		$s.pop();
...
tests.FiltersApplication.prototype.addTwo = function(value,context) {
	$s.push("tests.FiltersApplication::addTwo");
	var $spos = $s.length;
	{
		var $tmp = value + 2;
		$s.pop();
...
tests.FiltersApplication.prototype.__class__ = tests.FiltersApplication;
