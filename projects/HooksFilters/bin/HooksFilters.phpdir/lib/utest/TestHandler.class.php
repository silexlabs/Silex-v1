...
class utest_TestHandler {
	...
	public function addAsync($f, $timeout) {
		...
		{
			$»tmp = array(new _hx_lambda(array(&$f, &$handler, &$timeout), "utest_TestHandler_3"), 'execute');
			$GLOBALS['%s']->pop();
			return $»tmp;
		}
		$GLOBALS['%s']->pop();
...
function utest_TestHandler_1($f, $t) {
		...
		$»spos = $GLOBALS['%s']->length;
	{
		...
		{
			$»tmp = array(new _hx_lambda(array(&$f, &$t), "utest_TestHandler_5"), 'execute');
			$GLOBALS['%s']->pop();
			return $»tmp;
		}
		$GLOBALS['%s']->pop();
...
function utest_TestHandler_2($f, $t) {
		...
		$»spos = $GLOBALS['%s']->length;
	{
		...
		$»spos2 = $GLOBALS['%s']->length;
		{
			$»tmp = array(new _hx_lambda(array(&$f, &$t), "utest_TestHandler_6"), 'execute');
			$GLOBALS['%s']->pop();
			return $»tmp;
		}
		$GLOBALS['%s']->pop();
...
function utest_TestHandler_3(&$f, &$handler, &$timeout) {
		$GLOBALS['%s']->push('utest.TestHandler:lambda_3');
		$»spos = $GLOBALS['%s']->length;
	{
		$GLOBALS['%s']->push("utest.TestHandler::addAsync@115");
		$»spos2 = $GLOBALS['%s']->length;
...
function utest_TestHandler_4(&$f, &$handler, &$timeout, $e) {
		$GLOBALS['%s']->push('utest.TestHandler:lambda_4');
		$»spos = $GLOBALS['%s']->length;
	{
		$GLOBALS['%s']->push("utest.TestHandler::addEvent@133");
		$»spos2 = $GLOBALS['%s']->length;
		if(!$handler->asyncStack->remove($f)) {
...
function utest_TestHandler_5(&$f, &$t) {
...
function utest_TestHandler_6(&$f, &$t, $e) {
