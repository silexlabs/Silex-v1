...
class org_silex_serverApi_SiteEditor {
	...
	public function getWebsiteConfig($id_site, $mergeWithServerConfig = null) {
		$tmp = null;
	...
	public function loadPublicationStructure($siteName, $isPublishedVersion = null) {
	...
	public function getSectionSeoData($id_site, $deeplink, $urlBase = null) {
		$tmp = null;
